<?php
    ...
    $file = file_get_contents("theguardian.txt");
        ...
        if(!empty($feeds))
        {
            ...
            foreach ($feeds->channel->item as $item)
            {
                ...
                else
                {
                    ...
                    // GET DESCRPTION AND REMOVE "CONTINUE READING..." WHICH IS AT THE END OF EACH DESCRIPTION
                    ...
                    // CALCULATE HOW LONG CAN BE THE DESCRIPTION (500 - TITLE - SEPARATOR - 6X EOL - HASHTAGS - LINK - 3X DOTS - 10X RESERVE)
    ...
    file_put_contents("theguardian.txt", $file);
?>
